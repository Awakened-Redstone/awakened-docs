...
```json title="en_us.json"
{
  ...
  "discord.command.description.register.argument": "Your Minecraft username",
  "discord.command.description.info": "Shows information about your user",
  "discord.command.description.userinfo": "Shows information about the given user",
  "discord.command.description.userinfo.argument": "The user to show the information about",
  "discord.command.description.modify": "Modifies the whitelist entry for the given user, adds one if none is found",
  "discord.command.description.modify.argument/user": "The Discord user to modify the entry of",
  "discord.command.description.modify.argument/username": "The username to whitelist for the given user",
  ...
  "discord.command.register.username_already_registered.title": "This username is already registered",
  "discord.command.register.username_already_registered.message": "The username you inserted is already whitelisted on the server.",
  ...
  "discord.command.register.fatal.title": "Something went badly wrong",
  ...
  "discord.command.modify.username_already_registered.title": "This username is already registered",
  "discord.command.modify.username_already_registered.message": "The username you inserted is already whitelisted on the server.",
  "discord.command.modify.player_banned.title": "Can not add user",
  "discord.command.modify.player_banned.message": "The user was not added to the whitelist as the player with the username you inserted is be banned from the server.",
  ...
  "discord.command.modify.fatal.title": "Something went badly wrong",
  ...
  "discord.command.modify.fail.account_data": "Filed to get the public account data of `%s`. Is it a valid **Minecraft Java Edition** username?\n_It is only possible to register Minecraft Java Edition accounts._",
