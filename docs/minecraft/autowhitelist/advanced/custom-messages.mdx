...
```json title="en_us.json"
{
  ...
  "command.description.register.argument": "Your Minecraft username",
  "command.description.info": "Adds the informed minecraft account to the server whitelist.",
  "command.description.debug/userinfo": "Shows information about the given user [DEBUG COMMAND]",
  "command.description.debug/userinfo.argument": "The user to show the information about",
  ...
  "command.debug/userinfo.title": "User info",
  "command.debug/userinfo.description": "Information about %s",
  "command.debug/userinfo.roles": "Roles",
  "command.debug/userinfo.whitelisted": "Whitelisted",
  "command.debug/userinfo.qualifies": "Qualifies",
  ...
  "command.info.field.lock.title": "Lock expiration",
