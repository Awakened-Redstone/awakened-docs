...
<Steps>
    ...
    <Spoiler title={"Creating the bot"}>
      <LazyImage src={"https://raw.githubusercontent.com/Awakened-Redstone/Awakened-Redstone/master/assets/images/autowhitelist/create_bot_v2.gif"} alt={"Creating the bot gif"}/>
    </Spoiler>

    <Spoiler title={"Important settings"}>
      <LazyImage src={"https://raw.githubusercontent.com/Awakened-Redstone/Awakened-Redstone/master/assets/images/autowhitelist/bot_settings_v2.gif"} alt={"Important settings gif"}/>
    </Spoiler>

    <Spoiler title={"Getting the token"}>

        <LazyImage src={"https://cdn.glitch.global/b4fe08b2-a216-4ca6-a836-38b072b573c1/Screenshot_1403.png"} alt={"Getting the token"}/>
    </Spoiler>

    <Spoiler title={"Getting the client ID"}>

        <LazyImage src={"https://cdn.glitch.global/b4fe08b2-a216-4ca6-a836-38b072b573c1/Screenshot_1405.png"} alt={"Getting ClientId"}/>
    </Spoiler>

    <Spoiler title={"Adding to your server"}>

        <LazyImage src={"https://github.com/Awakened-Redstone/Awakened-Redstone/blob/master/assets/images/autowhitelist/adding_bot.gif?raw=true"} alt={"Adding to your server gif"}/>
    </Spoiler>
